...
export function Sidebar() {
  ...
  return (
    <aside className="w-[220px] shrink-0 flex flex-col py-4 border-r border-slate-100/60 bg-[rgba(248,249,253,0.8)] backdrop-blur-[12px] overflow-y-auto scrollbar-hide h-full">
      {/* User area */}
      <NavLink
        to="/settings/profile"
